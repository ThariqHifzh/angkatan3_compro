                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header fw-bold" style="font-size: x-large;">Data instruktur</div>
                                    <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-success btn-sm"
                                                                href="tambah-instruktur.php?edit=<?php echo $row['id'] ?>"><span class="tf-icon bx bx-pencil"></a>

                                                            <a class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Apakah Anda Yakin untuk Menghapus Data Ini?')"
                                                                href="instruktur.php?delete=<?php echo $row['id'] ?>"><span class="tf-icon bx bx-trash"></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile ?>
                                            </tbody>
