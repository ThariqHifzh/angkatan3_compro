...
if (isset($_POST['kirim-duarrr']) && isset($_GET['pesanId'])) {
    $id = $_GET['pesanId'];
    $email = $_POST['email'];
    $subject = $_POST['subject'];
    $balaspesan = $_POST['balaspesan'];

$headers = "From: thoriqhifzh@gmail.com" ."\r\n" .
            "Reply-To: thoriqhifzh@gmail.com" . "\r\n" .
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                    <legend class="float-none w-auto px-3 fw-bold">Balas Pesan</legend>
                                        <ul style="list-style-type: '-'">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control text-black" name="email" value="<?php echo $rowContact['email'] ?>" readonly>
                                                </div>
                                                <div class="mt-3">
                                                ...
                                                <div class="mt-3">
                                                    <button class="btn btn-primary" name="kirim-duarrr">Kirim Pesan</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
