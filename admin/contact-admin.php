...
if (isset($_GET['delete'])) {
    ...
    header("location:contact-admin.php?hapus=berhasil");
}
?>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header fw-bold" style="font-size: x-large;">Manage Contact</div>
                                    <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-success btn-sm"
                                                                href="kirim-pesan.php?pesanId=<?php echo $rowContact['id'] ?>"><span class="tf-icon bx bx-pencil"></a>

                                                            <a class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Apakah Anda Yakin untuk Menghapus Data Ini?')"
                                                                href="contact.php?delete=<?php echo $rowContact['id'] ?>"><span class="tf-icon bx bx-trash"></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile ?>
                                            </tbody>
